...
public class job_2 implements TalendJob {
	...
	public static class s2Struct implements
			routines.system.IPersistableRow<s2Struct> {
		final static byte[] commonByteArrayLock_PROJECT_job_2 = new byte[0];
		static byte[] commonByteArray_PROJECT_job_2 = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final s2Struct other = (s2Struct) obj;
		...
		public void copyDataTo(s2Struct other) {

			other.ID = this.ID;
			other.Adore = this.Adore;
			other.HAHA = this.HAHA;
			other.Anger = this.Anger;

		}

		public void copyKeysDataTo(s2Struct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJECT_job_2.length) {
					if (length < 1024
							&& commonByteArray_PROJECT_job_2.length == 0) {
						commonByteArray_PROJECT_job_2 = new byte[1024];
					} else {
						commonByteArray_PROJECT_job_2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJECT_job_2, 0, length);
				strReturn = new String(commonByteArray_PROJECT_job_2, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJECT_job_2) {
				...
				try {
					...
					this.Adore = dis.readInt();

					this.HAHA = dis.readInt();

					this.Anger = dis.readInt();
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				dos.writeInt(this.Adore);

				// int

				dos.writeInt(this.HAHA);

				// int

				dos.writeInt(this.Anger);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("ID=" + ID);
			sb.append(",Adore=" + String.valueOf(Adore));
		 ...
		 * Compare keys
		 */
		public int compareTo(s2Struct other) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("s2" + iterateId, 0, 0);
				...
				String tableName_tDBOutput_3 = "réactions";
				...
				String insert_tDBOutput_3 = "INSERT INTO `" + "réactions"
						+ "` (`ID`,`Adore`,`HAHA`,`Anger`) VALUES (?,?,?,?)";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							if (row1 != null) {
								...
								{ // start of Var scope
									...
									// # Output table : 's2'
									s2_tmp.ID = row1.Post_ID;
									s2_tmp.Adore = row1.LOVE;
									s2_tmp.HAHA = row1.HAHA;
									s2_tmp.Anger = row1.ANGER;
									s2 = s2_tmp;
									// ###############################
								...
								if (s2 != null) {
									...
									if (execStat) {
										runStat.updateStatOnConnection("s2"
												+ iterateId, 1, 1);
									}
									...
									if (s2.ID == null) {
										...
										pstmt_tDBOutput_3.setString(1, s2.ID);
									}

									pstmt_tDBOutput_3.setInt(2, s2.Adore);

									pstmt_tDBOutput_3.setInt(3, s2.HAHA);

									pstmt_tDBOutput_3.setInt(4, s2.Anger);
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null
							|| !((Boolean) resourceMap.get("inIterateVComp"))) {
						runStat.updateStatOnConnection("s2" + iterateId, 2, 0);
					}
				}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job_2.class.getClassLoader()
					.getResourceAsStream(
							"project/job_2_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 74225 characters generated by Talend Open Studio for Data Integration on the
 * 06 May 2022 12:48:19 PM
 ************************************************************************************************/
