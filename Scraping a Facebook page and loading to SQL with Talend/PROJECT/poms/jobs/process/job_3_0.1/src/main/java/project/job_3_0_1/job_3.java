...
/**
 * Job: job_3 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class job_3 implements TalendJob {
	...
	private final String jobName = "job_3";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(job_3.this, new Object[] { e,
	...
	public static class s3Struct implements
			routines.system.IPersistableRow<s3Struct> {
		final static byte[] commonByteArrayLock_PROJECT_job_3 = new byte[0];
		static byte[] commonByteArray_PROJECT_job_3 = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final s3Struct other = (s3Struct) obj;
		...
		public void copyDataTo(s3Struct other) {
		...
		public void copyKeysDataTo(s3Struct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJECT_job_3.length) {
					if (length < 1024
							&& commonByteArray_PROJECT_job_3.length == 0) {
						commonByteArray_PROJECT_job_3 = new byte[1024];
					} else {
						commonByteArray_PROJECT_job_3 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJECT_job_3, 0, length);
				strReturn = new String(commonByteArray_PROJECT_job_3, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJECT_job_3) {
		 ...
		 * Compare keys
		 */
		public int compareTo(s3Struct other) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("s3" + iterateId, 0, 0);
				...
				String tableName_tDBOutput_2 = "publication";
				...
				String insert_tDBOutput_2 = "INSERT INTO `" + "publication"
						+ "` (`ID`,`message`) VALUES (?,?)";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							if (row1 != null) {
								...
								{ // start of Var scope
									...
									// # Output table : 's3'
									s3_tmp.ID = row1.Post_ID;
									s3_tmp.message = row1.Message;
									s3 = s3_tmp;
									// ###############################
								...
								if (s3 != null) {
									...
									if (execStat) {
										runStat.updateStatOnConnection("s3"
												+ iterateId, 1, 1);
									}
									...
									if (s3.ID == null) {
										...
										pstmt_tDBOutput_2.setString(1, s3.ID);
									}
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null
							|| !((Boolean) resourceMap.get("inIterateVComp"))) {
						runStat.updateStatOnConnection("s3" + iterateId, 2, 0);
					}
				}
	...
	public static void main(String[] args) {
		final job_3 job_3Class = new job_3();

		int exitCode = job_3Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job_3.class.getClassLoader()
					.getResourceAsStream(
							"project/job_3_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = job_3.class.getClassLoader().getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : job_3");
		}
...
/************************************************************************************************
 * 73535 characters generated by Talend Open Studio for Data Integration on the
 * 06 May 2022 12:37:21 PM
 ************************************************************************************************/
