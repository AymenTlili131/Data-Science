...
public class job_1 implements TalendJob {
	...
	public static class s1Struct implements
			routines.system.IPersistableRow<s1Struct> {
		final static byte[] commonByteArrayLock_PROJECT_job_1 = new byte[0];
		static byte[] commonByteArray_PROJECT_job_1 = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final s1Struct other = (s1Struct) obj;
		...
		public void copyDataTo(s1Struct other) {
		...
		public void copyKeysDataTo(s1Struct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJECT_job_1.length) {
					if (length < 1024
							&& commonByteArray_PROJECT_job_1.length == 0) {
						commonByteArray_PROJECT_job_1 = new byte[1024];
					} else {
						commonByteArray_PROJECT_job_1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJECT_job_1, 0, length);
				strReturn = new String(commonByteArray_PROJECT_job_1, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJECT_job_1) {
		 ...
		 * Compare keys
		 */
		public int compareTo(s1Struct other) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("s1" + iterateId, 0, 0);
				...
				String tableName_tDBOutput_11 = "temps";
				...
				String insert_tDBOutput_11 = "INSERT INTO `" + "temps"
						+ "` (`ID`,`Date`) VALUES (?,?)";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							if (row1 != null) {
								...
								{ // start of Var scope
									...
									// # Output table : 's1'
									s1_tmp.ID = row1.Post_ID;
									s1_tmp.Date = row1.Publication_Date;
									s1 = s1_tmp;
									// ###############################
								...
								if (s1 != null) {
									...
									if (execStat) {
										runStat.updateStatOnConnection("s1"
												+ iterateId, 1, 1);
									}
									...
									if (s1.ID == null) {
										...
										pstmt_tDBOutput_11.setString(1, s1.ID);
									}

									if (s1.Date != null) {
										date_tDBOutput_11 = s1.Date.getTime();
										if (date_tDBOutput_11 < year1_tDBOutput_11
												|| date_tDBOutput_11 >= year10000_tDBOutput_11) {
											pstmt_tDBOutput_11.setString(2,
													"0000-00-00 00:00:00");
										} else {
											pstmt_tDBOutput_11.setTimestamp(2,
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null
							|| !((Boolean) resourceMap.get("inIterateVComp"))) {
						runStat.updateStatOnConnection("s1" + iterateId, 2, 0);
					}
				}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job_1.class.getClassLoader()
					.getResourceAsStream(
							"project/job_1_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 74492 characters generated by Talend Open Studio for Data Integration on the
 * 06 May 2022 1:46:14 PM
 ************************************************************************************************/
